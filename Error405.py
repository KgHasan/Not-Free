...
import os,sys
try: import requests
except ModuleNotFoundError:print("biki Install Module requests");os.system("python -m pip install requests &> /dev/rizwan")
try: import bs4
except ModuleNotFoundError:print("biki Install Module bs4");os.system("python -m pip install bs4 &> /dev/rizwan")
try: import mechanize
except ModuleNotFoundError:print("biki Install Module mechanize");os.system("python -m pip install mechanize &> /dev/rizwan")
try: import gTTS
